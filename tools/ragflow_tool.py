...
# load_dotenv() 
# 或者指定路径:
load_dotenv(".env") # 使用你实际的 .env 文件路径

RAGFLOW_BASE_URL = os.getenv("RAGFLOW_API_URL")
RAGFLOW_API_KEY = os.getenv("RAGFLOW_API_KEY")

def query_ragflow_service(user_query: str, chat_id: str = "815099f0107e11f08d3a0242ac140006"):
    """
...
if __name__ == "__main__":
    # 测试调用
    print(query_ragflow_service("gemini有什么作用"))"
"""